...
export const getActivePageBySlugQuery = `*[_type == "page" && slug.current == $slug && isActive == true][0]{
  ...
  campScheduleBlocks[]{ titleHu, titleEn, bulletsHu, bulletsEn },
  campSupportersSectionTitleHu,
  campSupportersSectionTitleEn,
  campSupporters[]{ nameHu, nameEn, url },
  runningEyebrowHu,
  runningEyebrowEn,
  runningFreeEntryBannerHu,
  runningFreeEntryBannerEn,
  runningCardDateHu,
  runningCardDateEn,
  runningCardTime,
  runningCardLocationHu,
  runningCardLocationEn,
  ...
  runningEntryDeadlineHu,
  runningEntryDeadlineEn,
  runningResultsNoteHu,
  runningResultsNoteEn,
  isActive,
  seo
}`;
