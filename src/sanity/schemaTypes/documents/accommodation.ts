...
export const accommodationType = defineType({
  ...
  fields: [
    ...
    defineField({ name: "bookingLabelHu", title: "Foglalás gomb felirat (HU)", type: "string", initialValue: "Foglalás →" }),
    defineField({ name: "bookingLabelEn", title: "Booking button label (EN)", type: "string", initialValue: "Book →" }),
